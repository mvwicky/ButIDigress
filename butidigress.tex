...
\titleformat{\section}[block]{\filcenter\Large}{\thesection\headerdelim}{1cm}{\bfseries\hspace{\headerskip}}[\rule{\titlewidth}{0.8pt}]
\titleformat{\subsection}[block]{\filcenter\large}{\thesubsection}{1cm}{\bfseries\hspace{\headerskip}}[\rule{\titlewidth}{0.5pt}]
\titleformat{\subsubsection}[block]{\filcenter\small}{\thesubsubsection}{1cm}{\bfseries\hspace{\headerskip}}[\rule{\titlewidth}{0.3pt}]
...
\vspace*{\stretch{2}}
\begin{center}
{\noindent\Large\textbf{About the Typeface}}\ftnote{Description from \url{https://fonts.google.com/specimen/Spectral}}\ftnote{Description from \url{https://github.com/source-foundry/Hack}}
