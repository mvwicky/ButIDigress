...
\titleformat{\section}[display]{\Large}{\thesection\filright}{0cm}{\bfseries\filcenter}[\rule{0.5\textwidth}{0.8pt}]
\titleformat{\subsection}[display]{\large}{\thesubsection}{0cm}{\bfseries\filcenter}[\rule{\titlewidth}{0.5pt}]
\titleformat{\subsubsection}[display]{\small}{\thesubsubsection}{0cm}{\bfseries\filcenter}[\rule{\titlewidth}{0.3pt}]
