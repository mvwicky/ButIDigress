...
\DefineFNsymbols{custom}{*\maltese\textdollar\textdagger\textparagraph\pounds\#\ddag{**}\S{\textdollar\textdollar}{\textdagger\textdagger}{\ddag\ddag}}
\renewcommand{\textbardbl}{\pounds}
% \setfnsymbol{lamport-robust}
\setfnsymbol{custom}
