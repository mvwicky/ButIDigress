...
A key insight gleaned from \book{The Subject of Semiotics}\ftnote{a book I intend to read again and soon} is that unconscious or unintentional symbolism (i.e., signification) is essentially unavoidable in all texts.\ftnote{heads up, this is the only semiotics book I've read, so, not exactly an expert}
