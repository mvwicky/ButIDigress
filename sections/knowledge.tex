...
\lettrine{I}{ have}, on several occasions, said something to the effect of that my greatest and continuing regret in my life is that I don't know everything.\ftnote{A pretty hilariously unverifiable statement.}
...
\digsec{Asymptotic Truth}{5}{13}{18}{asymptotic}
\epi{Certainty generally is illusion, and repose is not the destiny of man.}{\attrib{Oliver Wendell Holmes Jr.}{The Path of the Law}{1897}}
...
To wit, knowledge is never absolute, things that we know to be \say{true} are in fact \emph{asymptotically true}.\ftnote{A corollary to being empathetic (Chapter~\ref{chap:empathy}) is the idea that, never should one be completely confident in oneself.}

What does that even mean?\ftnote{For sure came up with this idea while super tired a couple days after graduation.}
...
What I'm getting at is that there is a deep, potentially untraversable, divide between what we (as humans, or as individuals) \emph{know} and what is \emph{true}.\ftnote{This idea was elucidated pretty clearly in \movie{Men in Black}, when Tommy Lee Jones (Agent K) basically says that exact phrase to Will Smith (soon to be Agent J).}\ftnote{Insofar as complete truth is even a thing.}

Instead of complete certainty, we have this asymptotic behavior, which is how I resolve my commitment to uncertainty with that which is viewed as \say{objectively true.}
...
But we, as humans, cannot ever get to that infinity, limits are a mathematical tool, they don't exist in \say{reality.}
...
There is no way to get out of one's reality\ftnote{That we know of.}, to eliminate bias, but one can ameliorate it a bit, by recognizing the specifics of how one views the world, and trying to correct for it.\ftnote{This is a whole other can of worms that I should probably get into below.}
...
As a phenomenon, what I'll be referring to \say{Nerd} culture, is a fascinating example, a horribly exclusionary and chauvinistic example, of resistance to change and ardent denial of reality.\foottodo{Explanation of nerd culture, like, what it is and stuff. Also maybe get into \#Gamergate.}
...
Looking back, the \say{maleness} of this niche subculture came to seem almost preordained.\ftnote{Some have even gone as far to make biological arguments for the cultural. See \Fref[vario]{sec:googlememo}.}
...
Pursuant to my insatiable desire to learn\ftnote{Boy, does this whole paragraph and chapter and book just make me feel conceited}, I try to read books of varying subjects.
...
I have never wanted to be \say{just} an engineer, it feels too confining.\ftnote{And it feels like I'm just looking out for number one.}
...
\digsec{Unconscious Signification}{6}{1}{18}{unconscioussig}
...
My firm commitment to art's relationship with the artist is, in fact, a pretty big part of my philosophy, it is partially why I unhesitatingly and without reservation abandon art made by those unmasked to be horrible people.\ftnote{There really wasn't a super appropriate place to put this; this chapter is a bit of a catch-all (because knowledge is kinda everything).}
...
All of linguistics can, theoretically, be derived from semiotics,\ftnote{The derivation would take an eternity and would be cumbersome to say the least. It's a bit like if given a unified theory of physics, deriving orbital mechanics, technically the theory has the capacity, but a direct proof would not be exactly feasible.} but it also encompasses so much more; Saussure developed his version from the point of view of a linguist, Peirce from the point of view of a philosopher, so, needless to say, the field is vast and contradictory.
...
A key concept, in Peircean semiotics, is that of the \say{signification chain,} which is a phenomenon by which a signified is a signifier for some other \say{thing,}\ftnote{Thing in the most general sense possible.} which then signifies something else, and so on and so forth.
...
Maintaining at least some knowledge of current events is also important regarding ideas which are laid out in the chapter on \say{The Immutable.}\ftnote{\Fref[vario]{chap:immutable}}
Come to think of it, this ties into the stuff I talk about in \say{Empathy,}\ftnote{\Fref[vario]{chap:empathy}} at least it does for me specifically.\ftnote{Like I said, no chapter of this book is entirely monolithic. It's actually a bit of a problem.}

\begin{somenotes}{Being Informed}
    \item Ties into empathy---reductive, but it helps me \say{know for whom I should feel bad.}
\end{somenotes}

\digsec{Just How Do You Learn Yourself Knowledge?}{6}{18}{18}{selfstudy}
Through the trials and tribulations of my quest for complete knowledge,\ftnote{I.e., omniscience, which honestly sounds like a nightmare, also I'm pretty sure the human brain would kinda just explode.} I've learned much about how to teach myself new and unfamiliar concepts.\foottodo{more anecdotes.}
...
Relevant to my entire life at this point, programming.\ftnote{I'm real good at integrating it into every single aspect of my life. Like this book for instance, I could have just made a Google Doc like everyone else, but nope, I had to make it nerdy as hell.}
...
Because of my perceived familiarity, I got into the habit of only half paying attention\ftnote{Probably closer to like, third or even fourth paying attention.} during the class period.
...
Honestly, this \say{checking out} was a bit of an epidemic in my senior year of college.
...
\begin{somenotes}{Studying on One's Own}
    \item gotta slog through the \say{beginner} level stuff at the beginning
\end{somenotes}
