...
While, it's true, I don't subscribe to absolute truths, only \say{asymptotic truths\ftnote{See~\fref{sec:asymptotic}.}.} that applies mostly for big picture things.
