...
While I don't subscribe to absolute truths, , it's true, only \say{asymptotic truths,}\ftnote{See~\fref{sec:asymptotic}.} that applies mostly for big picture things.
