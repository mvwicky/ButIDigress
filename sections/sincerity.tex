...
Some hay was made out of the sources of empathy in \tvshow{The Office} in section~\ref{sec:theoffice}\ftnote{Page~\pageref{sec:theoffice}} and, as I've noted\ftnote{In the note right above this one.} sincerity goes a long way in generating empathy.
...
While these shows are, on a surface level, incongruous with the bubbly, hopeful examples I've discussed above, they do represent real sincerity, even though the truths\ftnote{Truths in the sense that the creators/writers of those shows truly believe them, e.g., the cynicism or nihilism shown in \tvshow{BoJack} or \tvshow{The 100}, respectively. Not that believing something in one's heart of hearts necessarily makes that idea legitimate. But making media based on that belief is, by definition, sincere.} they espouse are not great and pretty much entirely orthogonal to the spirit of say, \tvshow{Parks and Rec}.
