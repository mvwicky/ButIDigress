...
The quotation on the previous page elucidates the idea behind this point more eloquently than I ever could.\margintodo{Find a new fuckin' quote, b/c there is some good shit here}
...
\margintodo{change this to reflect sincerity}\margindate{6/3/18}His career has shown that he, so far, is a virtuoso in empathy; he creates characters with whom one truly wants to connect.\footnote{additionally notable in his work is the \textcolor{red}{empathy} (see \cref{chap:empathy}) it shows (this helps one to connect with characters as well)}
