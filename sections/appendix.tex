...
\margindate{4:26 PM}Couldn't really think of anything to write this morning besides more stuff about \textit{The 100}\ftnote{which I wrote down in my journal, for later transcription}
...
\begin{itemize}
    \item[1.] \textbf{\textit{Short Term 12}} --- A beautiful, intimate film\ldots\marginthought{gonna be honest, starting to think of \movie{Short Term 12} more as the leader, just feel more of a connection to it (\texttt{6/7/18})}
