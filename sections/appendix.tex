...
\margindate{10:21 AM}Just finished breakfast and am sitting in the same coffee shop that I went to yesterday\ftnote{\textit{Uncommon Grounds}}.
Now I have to wait roughly an hour for my car to finished getting fixed.

As I was walking back from breakfast\ftnote{at \textit{Handy's Lunch}}, I had a thought argument\ftnote{super Stefon voice: it's that thing when you have an argument with an imaginary person in your head to help prove a point to yourself} about this, my, generation.
...
\margindate{3:34 PM}Dateline Columbus: forgot entirely to write this morning which kinda sucks, but\ftnote{haha, sucks butt} now I'm in the first city I was really dying to visit.\margincomm{if you don't know why I'm so excited, go ahead and watch the movie \movie{Columbus}, it's great}
...
\margindate{9:33 AM}Gosh dang, \tvshow{The 100} is an awesome show.
...
\margindate{4:26 PM}Couldn't really think of anything to write this morning besides more stuff about \tvshow{The 100}\ftnote{which I wrote down in my journal, for later transcription}
...
\begin{itemize}
    ...
    \item[7.] \textbf{\movie{Detention}} --- Just bizarre\ldots
