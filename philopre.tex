...
\newcommand{\epi}[2]{\epigraph{#1}{#2}\stepcounter{epicounter}}
...
\NewDocumentCommand\digsec{mmm}{\section{#1}\margindate{#2}\label{sec:#3}}
\NewDocumentCommand\digsubsec{mmm}{\subsection{#1}\margindate{#2}\label{subsec:#3}}
\NewDocumentCommand\digsubsubsec{mmm}{\subsubsection{#1}\margindate{#2}\label{subsubsec:#3}}
...
\newcommand{\notescolor}{teal}
\newenvironment{somenotes}[1]{\subsection*{\scshape Some Notes On: #1}\begin{itemize}[leftmargin=0pt,parsep=1pt,itemsep=1pt]\color{\notescolor}}{\end{itemize}}
