...
\newcommand{\margincomm}[1]{\marginnote{\scshape\textcolor{MidnightBlue}{#1}}}                 % Commentary on this particular section
\newcommand{\margintodo}[1]{\marginnote{\textcolor{red}{#1}}}                                    % TODO note
\newcommand{\margindate}[1]{\reversemarginpar\marginnote{\textcolor{Olive}{#1}}\normalmarginpar} % A last modifed date
