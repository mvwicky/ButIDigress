...
\begin{itemize}
    ...
    \item {\datestyle\textcolor{\datecolor}{Date notes contain the date or time I started the current section\\ or paragraph}}
\end{itemize}
...
The chapters, as I could decide no other appropriate order, are alphabetical (excluding \say{the} in a single chapter).\margindate{5}{14}{2018}
