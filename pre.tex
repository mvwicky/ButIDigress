...
% TODO: See if this looks okay with a light, small width hrule
\newcommand{\entryskip}{\vspace*{\baselineskip}}
% \def\entryskiplen{0.5\baselineskip}
% \newcommand{\entryskip}{\vspace{\entryskiplen}\noindent\hfill\rule{0.25\textwidth}{0.5pt}\hfill\vspace{\entryskiplen}}

% \newcommand{\cref}[1]{Chapter~\ref{#1} starting on page~\pageref{#1}}
% \newcommand{\cref}[1]{\fref[vario]{#1}}
