...
% B/c I used `\say` a bunch before I started actually using csquotes
...
\newcommand{\notescolor}{teal}
\newenvironment{somenotes}[1]{\par\entryskip{\large\centering\noindent\textbf{\textsc{Some Notes On: #1}}}\begin{itemize}[leftmargin=0pt,parsep=1pt,itemsep=1pt]\color{\notescolor}}{\end{itemize}}
...
\newcommand{\lengthtoinches}[2]{\setlength{#1}{#2 / \real{72.27}}}

% \titleformat{\part}[frame]{\Large}{\filright\enspace{\Large \parttitlename~\thepart}\enspace}{2cm}{\LARGE\bfseries\filcenter}
